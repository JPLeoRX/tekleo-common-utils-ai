...
# Open labelme
labelme_folder_path = "/tekleo_common_utils_ai/test_utils_dataset_labelme/dataset_labelme"
...
# Save to coco
coco_folder_path = "/tekleo_common_utils_ai/test_utils_dataset_labelme/dataset_coco"
